...
class AppDelegate: UIResponder, UIApplicationDelegate, WCSessionDelegate {
    ...
    func session(_ session: WCSession, didReceiveMessage ContactTempStore: [String : Array<String>]){
        // Receive messages from watch
        let recipNumberString = ("\(ContactTempStore["name"]![0])")
        let recipNameString = ("\(ContactTempStore["number"]![0])")
